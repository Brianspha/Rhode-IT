...
namespace RhodeIT.ViewModels
{
    public class MapsTabViewModel : INotifyPropertyChanged
        ...
        public MapsTabViewModel(SlideMenuView slideMenu, Command close, Command show)
        {
            ...
            await db.addDockingStationAsync(dockingStation);//@dev in future i will check the value returned
        ...
        {
            //@dev get pin details
            SlideUp = new AvailableBicycles(e.Pin.Label,ShowMenue,CloseMenu,Main);
